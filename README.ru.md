...
7. Создайте .env файл в папке, где находится проект, в него добавьте следующие переменные (ниже указан пример с вымышленными данными):
   ...
   <details open>
   <summary><{scroll-margin-top: 50px}h4>Как зарегистрировать нового бота в Telegram:</h4></summary>
   ...
   <details open>
   <summary><h4>Как установить API соединение с Google Sheets.</h4></summary>
